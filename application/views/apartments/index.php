...
<table class="apartments">
	...
	<?php $lcd = $apartment['last_clean_date']; ?>
        <tr class="apartment-entity">
            ...
            <td data-sort="days" class="text-right"><?= date('Y-m-d', strtotime($lcd . " + 3 days")); ?></td>
            <td data-sort="days" class="text-right"><?= date('Y-m-d', strtotime($lcd . " + 7 days")); ?></td>
            <td data-sort="days" class="text-right"><?= date('Y-m-d', strtotime($lcd . " + 14 days")); ?></td>
			<?php if (!$isViewer) : ?>
				<td>
